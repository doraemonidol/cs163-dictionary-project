...
/// </summary>
public
ref class mainFunction : public System::Windows::Forms::Form {
public:
...
private:
    System::Void btnAddFavor_Click(System::Object ^ sender, System::EventArgs ^ e)
    {
...
private:
    System::Void btnAddKeyword_Click(System::Object ^ sender, System::EventArgs ^ e)
    {
...
private:
    System::Void btnConfSwData_Click(System::Object ^ sender, System::EventArgs ^ e)
    {
        if (dataSetOpt->Text != curDataset) {
            ...
            MessageBox::Show(wordNum + " words from " + curDataset + " loaded!", "Status", MessageBoxButtons::OK, MessageBoxIcon::Asterisk);
            hideAll();
        }
...
private:
    System::Void btnResetDatset_Click(System::Object ^ sender, System::EventArgs ^ e)
    {
        ...
        key = dictTree.key;
        def = dictTree.def;
        MessageBox::Show("Dataset " + curDataset + " reloaded!", "Status", MessageBoxButtons::OK, MessageBoxIcon::Asterisk);
        searchBox->Text = L"";
        panShowDef->Hide();
    }
...
private:
    System::Void defLabel_TextChanged(System::Object ^ sender, System::EventArgs ^ e)
    {
        ...
        if (st.length() > 1440)
            ...
            defLabel->ScrollBars = System::Windows::Forms::ScrollBars::None;
    }
};
}
